...
namespace TorKartingowyCoreMVC.Migrations
{
    ...
    [Migration("20230125141224_ChangeRekordInKlientToString")]
    partial class ChangeRekordInKlientToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TorKartingowyCoreMVC.Models.Cennik", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("DlaDzieci")
                        .HasColumnType("float");

                    b.Property<double>("DodatkoweSzkolenie")
                        .HasColumnType("float");

                    b.Property<double>("Elektryczny")
                        .HasColumnType("float");

                    b.Property<double>("Spalinowy")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TorKartingowyCoreMVC.Models.Harmonogram", b =>
                {
                    b.Property<string>("OdKiedy")
                        .HasColumnType("nvarchar(450)");

                    b.Property<byte[]>("ListaGodzin")
                        .IsRequired()
            ...
            modelBuilder.Entity("TorKartingowyCoreMVC.Models.Magazyn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TorKartingowyCoreMVC.Models.Platnosc", b =>
                {
                    b.Property<int>("Numer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RodzajDokumentu")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TorKartingowyCoreMVC.Models.Rezerwacja", b =>
                {
                    ...
                    b.HasOne("TorKartingowyCoreMVC.Models.Platnosc", "Platnosc")
                        .WithMany()
                        .HasForeignKey("PlatnoscNumer")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
